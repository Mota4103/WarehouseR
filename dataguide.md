...
- Total Man-Hours = จำนวนคนงาน × ชั่วโมงการหยิบที่แท้จริง
                  = 80 คน × 2.3 ชั่วโมง = 184 man-hours/วัน
```

**หมายเหตุสำคัญ: Effective Picking Hours**
- พนักงาน 80 คน แบ่งเป็น 2 กะ (กลางวัน 08:00-17:00+OT, กลางคืน 23:00-08:00)
- แต่ละกะ 9 ชั่วโมง แต่เวลาที่ใช้หยิบจริงน้อยกว่า เนื่องจาก:
  - เวลาพัก (lunch, personal breaks)
  - เวลาเดินทาง, ค้นหา WMS
  - งานอื่นๆ นอกเหนือจากการหยิบ
- **Effective picking hours ≈ 2.3 ชั่วโมง/คน/วัน** (คำนวณย้อนกลับจาก PDF Figure 7)
...
4. **คำนวณ Lines/Man-Hour** = TotalLines / 184
...
- **ค่าเฉลี่ย: 7.63 lines/man-hour** (ไม่รวมช่วงน้ำท่วม)
- **ค่าอ้างอิง PDF Figure 7: 7.76**
- **ความแม่นยำ: ภายใน 2%** ของค่าอ้างอิง
- **Effective picking hours: 2.3 ชั่วโมง/คน/วัน** (ไม่ใช่ 9 ชั่วโมงเต็ม)
- **Man-hours/day: 184** (80 คน × 2.3 ชม.)
